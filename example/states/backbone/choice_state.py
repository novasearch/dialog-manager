...
from example.events.intent_events.ChooseIntent import ChooseIntent


class ChoiceState(AbstractState, BackboneFlow):

    def __init__(self):
        self.event_functions = {
            ChooseIntent: self.event_dummy
        }
