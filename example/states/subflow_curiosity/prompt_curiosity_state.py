...
from example.dialog_factory.flows import CuriosityFlow
from example.events.custom_events.PromptCuriosityEvent import PromptCuriosityEvent


class PromptCuriosityState(AbstractState, CuriosityFlow):

    def __init__(self):
        self.event_functions = {
            PromptCuriosityEvent: self.event_dummy
        }
    ...
    def register_transitions_in() -> dict:
        ...
        return {
            StepState: [PromptCuriosityEvent]
        }
