...
from example.events.intent_events.AskToolsIntent import AskToolsIntent


class ListToolsState(AbstractState, RecipeInfoFlow):

    def __init__(self):
        self.event_functions = {
            AskToolsIntent: self.event_dummy
        }
