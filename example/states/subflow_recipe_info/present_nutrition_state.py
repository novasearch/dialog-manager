...
from example.events.intent_events.AskNutritionIntent import AskNutritionIntent


class PresentNutritionState(AbstractState, RecipeInfoFlow):

    def __init__(self):
        self.event_functions = {
            AskNutritionIntent: self.event_dummy
        }
